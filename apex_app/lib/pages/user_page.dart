...
class _UserPageState extends State<UserPage> {
  ...
  Future<List<String>> fetchCameras() async{
    ...
    try {
      ...
      if (response.statusCode == 200) {
        ...
        return responseData.map<String>((data) {
          return ' CID : ${data['serial_number']}, \n \t PS : ${data['polling_id']} ${data['polling_station_name']}, \n \t AC : ${data['ac_name']}, \n \t OP : ${data['operator_name']}';
        }).toList();
      ...
      if (response.statusCode == 200) {
        ...
        setState(() {
          pollingStationIdList = responseData.map((data) {
            return 'PS : ${data['pid']} ${data['polling_station_name']}';
          }).toList();
        });
  ...
  Future<void> registerCamera(modelNumber,pollingStation,operator,cameraInside) async{
                              ...
                              child: Scaffold(
                                                  ...
                                                  children: [
                                                    const Padding(
                                                      ...
                                                      child: RoundCheckBox(
                                                        ...
                                                        onTap: (selected) {
                                                          setState(() {
                                                            cameraInside=selected!;
                                                          });
                                                        },
                                                        uncheckedColor: Colors.grey.shade200,
                                                        checkedColor: Colors.green,
                                                        uncheckedWidget: Icon(Icons.check_box_outline_blank, color: Colors.grey),
                                ...
                                floatingActionButton: FloatingActionButton.large(
                                  onPressed: (){
                                    ...
                                    registerCamera(serialNumberController.text,pollingStationId?.replaceFirst(RegExp(r'PS : \d+ '), '').trim(),username,cameraInside);
                                  },
                                  backgroundColor: Colors.blue,
